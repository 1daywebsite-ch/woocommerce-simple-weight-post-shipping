<?php
class WC_Simple_Weight_Post_Express_Method extends WC_Shipping_Method {
	/**
	 * Constructor.
	 *
	...
	public function __construct( $instance_id = 0 ) {
		$this->id = 'wcw_post_express';
		$this->instance_id = absint( $instance_id );
		$this->method_title = __( 'Swiss-Express «Mond»', 'wc-simple-weight' );  
		$this->method_description = __( 'Swiss-Express «Mond» (nächster Werktag bis 9 Uhr, inkl. MWST) - Enable this method if you want to offer Swiss-Express «Mond» as a shipping method', 'wc-simple-weight' ); 
	...
	function init_form_fields() { 
		$this->form_fields = array(
			...
			'title' => array(
				'title' => __( 'Swiss-Express «Mond» (nächster Werktag bis 9 Uhr, inkl. MWST)', 'wc-simple-weight' ),
				'type' => 'text',
				'description' => __( 'Title to be displayed on cart and checkout page', 'wc-simple-weight' ),
				'default' => __( 'Swiss-Express «Mond» (nächster Werktag bis 9 Uhr, inkl. MWST)', 'wc-simple-weight' )
			),
			'postpac_till_2kg' => array(
				'title' => __( 'Swiss-Express «Mond» bis 2 kg', 'wc-simple-weight' ),
				'type' => 'number',
				'default' => 18
			),
			'postpac_till_10kg' => array(
				'title' => __( 'Swiss-Express «Mond» bis 10 kg', 'wc-simple-weight' ),
				'type' => 'number',
				'default' => 22
			),
			'postpac_till_30kg' => array(
				'title' => __( 'Swiss-Express «Mond» bis 30 kg', 'wc-simple-weight' ),
				'type' => 'number',
				'default' => 29
			)
		);
